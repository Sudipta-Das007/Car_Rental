...
import 'package:car_rental/carSelect/car_list_item2.dart';
...
class Selectcar2 extends StatelessWidget {
  String selectedVal = '';
  String selectedVal1 = '';
  String selectedVal2 = '';
  String selectedVal3 = '';
  ...
  Selectcar2({required this.selectedVal,
    ...
    return Scaffold(
      ...
      body:Container(
              child: ListView.builder(
                ...
                itemBuilder: ((context, index) => CarListItem2(index)
              )
              ),
            ),
    );
