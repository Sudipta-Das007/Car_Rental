...
import 'package:car_rental/carSelect/car_list_item3.dart';
...
class Selectcar3 extends StatelessWidget {
  String selectedVal = '';
  String selectedVal1 = '';
  String selectedVal2 = '';
  String selectedVal3 = '';
  ...
  Selectcar3({required this.selectedVal,
    ...
    return Scaffold(
      ...
      body:Container(
              child: ListView.builder(
                ...
                itemBuilder: ((context, index) => CarListItem3(index)
              )
              ),
            ),
    );
