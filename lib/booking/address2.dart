...
import 'package:car_rental/booking/check_details2.dart';
...
class Address2 extends StatefulWidget {
  ...
  @override
  State<Address2> createState() => _AddressState(image: image, price: price, brand: brand, luggage: luggage, min_fare: min_fare, seats: seats);
}

class _AddressState extends State<Address2> {
          ...
          child: SingleChildScrollView(
            child: Container(
                  ...
                  child: ElevatedButton(onPressed: (){
                    ...
                    print(brand);
                    if(isValid == true){
                    Navigator.push(context, MaterialPageRoute(builder: (context) => Check_details2(
                      brand: brand,
                      image: image,
                      price: price,
                      luggage: luggage,
