...
class Check_details3 extends StatelessWidget {
  ...
  Check_details3({required this.price,
           required this.brand,
          ...
          child: Column(
            children: [
              ...
              Container(
                padding: EdgeInsets.symmetric(vertical: 10, horizontal: 25),
                alignment: Alignment.topLeft,
                child: Text('Pickup Point: Delhi Airport',
                  style: TextStyle(
                  color: Colors.black,
                  fontSize: 22,
                  ),),
              ...
              Container(
                padding: EdgeInsets.symmetric(vertical: 10, horizontal: 25),
                alignment: Alignment.topLeft,
                child: Text('Pickup Date: Dec 27,2022',
                  style: TextStyle(
                  color: Colors.black,
                  fontSize: 22,
                  ),),
              ...
              /*Container(
                padding: EdgeInsets.symmetric(vertical: 10, horizontal: 25),
                alignment: Alignment.topLeft,
                child: Text('SelectedVal4: ${selectedVal4}',
                  style: TextStyle(
                  color: Colors.black,
                  fontSize: 22,
                  ),),
              ...
              Container(
                padding: EdgeInsets.symmetric(vertical: 10, horizontal: 25),
                alignment: Alignment.topLeft,
                child: Text('SelectedVal5: ${selectedVal5}',
                  style: TextStyle(
                  color: Colors.black,
                  fontSize: 22,
                  ),),
